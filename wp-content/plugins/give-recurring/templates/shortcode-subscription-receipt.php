...
if ( ! empty( $subscriptions_page ) && get_post( $subscriptions_page ) ) {
	echo '<a href="' . give_get_subscriptions_page_uri() . '" class="give-recurring-manage-subscriptions-receipt-link">' . __( 'Manage Subscriptions', 'give-recurring' ) . ' &raquo;</a>';
}
