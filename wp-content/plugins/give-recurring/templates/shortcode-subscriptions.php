 ...
 *
 * Note: this filter is deprecated and can be remove in future, use give_recurring_get_subscription_statuses_key filter with appropriate conditions.
 *
 * @deprecated 1.5.8
 */
...
$subscriptions          = $subscriber->get_subscriptions( 0, array(
