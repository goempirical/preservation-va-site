...
class Give_Subscription {
	...
	public function get_renewal_date() {
		...
		if ( $expires > current_time( 'timestamp' ) && $this->is_active() ) {
			return date_i18n( give_date_format(), strtotime( $this->expiration ) );
		}
		...
		return date_i18n( give_date_format(), strtotime( '+ ' . $frequency . $this->period . ' 23:59:59', $last_payment_timestamp ) );
