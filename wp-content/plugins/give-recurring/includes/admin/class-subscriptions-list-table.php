...
class Give_Subscription_Reports_Table extends WP_List_Table {
			...
			<div id="give-payment-date-filters">
				<div class="give-filter give-filter-half">
					<label for="start-date"
					       class="give-start-date-label"><?php esc_html_e( 'Start Date', 'give-recurring' ); ?></label>
					<input type="text" id="start-date" name="start-date" class="give_datepicker"
					       value="<?php echo $start_date; ?>" placeholder="mm/dd/yyyy" />
				</div>
				<div class="give-filter give-filter-half">
					<label for="end-date" class="give-end-date-label"><?php esc_html_e( 'End Date', 'give-recurring' ); ?></label>
	...
	public function search_box( $text, $input_id ) {
		...
		<p class="search-box" role="search">
			...
			<input type="search" id="<?php echo $input_id ?>" name="s" placeholder="<?php esc_html_e( 'Search subscriptions', 'give-recurring' ); ?>"
