...
class Give_Renewal_Subscriptions_Email_Access extends Give_Email_Notification {
	...
	public function setup_email_data() {
		 ...
		 *
		 * @return string $header Header text for email
		 */
		$header = apply_filters( "give_{$this->config['id']}_email_access_token_heading", __( 'Confirm Email', 'give-recurring' ) );

		Give()->emails->__set( 'heading', $header );
	}
}
