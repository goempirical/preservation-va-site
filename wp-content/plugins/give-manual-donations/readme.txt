...
Contributors: wordimpress, dlocc, webdevmattcrom, ravinderk, ramiy
...
= 1.1 =
* Fix: Main heading CSS conflict on donation listing page when a wp-admin notice was displayed. https://github.com/WordImpress/Give-Manual-Donations/issues/22
* Fix: Do not show "None" as an option for multi-level donation forms. https://github.com/WordImpress/Give-Manual-Donations/issues/38
* Fix: When there are more than 30 donation forms, they don't show up donation form dropdown select. https://github.com/WordImpress/Give-Manual-Donations/issues/42
* Tweak: Renamed `give_create_payment` action to `give_create_manual_payment` and `give_create_payment_nonce` to `give_create_manual_payment_nonce` to prevent potential conflicts with Give core. https://github.com/WordImpress/give-manual-donations/issues/39
...
= 1.0.1 =
* Fix: Decimal amounts are now supported and validated according to currency settings - https://github.com/WordImpress/give-manual-donations/issues/27
